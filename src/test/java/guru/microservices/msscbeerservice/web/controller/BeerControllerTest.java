...
class BeerControllerTest {
        ...
        mockMvc.perform(get("/api/v1/beer/{beerId}", UUID.randomUUID().toString())
                ...
                .andDo(document("v1/beer-get",
                        ...
                        responseFields(
                                ...
                                fieldWithPath("localDate").description("Local Date"),
    ...
    void saveNewBeer() throws Exception {
        ...
        ConstainedFields fields = new ConstainedFields(BeerDto.class);
        ...
        mockMvc.perform(post("/api/v1/beer/")
                ...
                .andDo(document("v1/beer-new",
                        requestFields(
                                ...
                                fields.withPath("localDate").description("Local Date"),
    ...
    private static class ConstainedFields {

        private final ConstraintDescriptions constraintDescriptions;

        ConstainedFields(Class<?> input) {
